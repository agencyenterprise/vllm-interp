"""Test pre-computed vector steering with Llama 3.1 8B.
...
VECTORS_PATH = "/home/user/wikipedia_contrastive_dataset.pt"
METADATA_PATH = "/home/user/wikipedia_metadata_l19.json"
...
async def main():
    ...
    engine = AsyncLLMEngine.from_engine_args(
        AsyncEngineArgs(
            ...
            # Vector steering config — apply at layer 19 (extraction layer)
            steering_layer=19,
