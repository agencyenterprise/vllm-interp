...
class LlamaDecoderLayer(nn.Module):
    ...
    def __init__(self,
                 ...
                 cached_codecs: Optional[dict[int, InterpCodec]] = None) -> None:
        super().__init__()
    ...
    def forward(
        ...
        if feature_enabled and self.cached_codecs is not None:
            features = self.cached_codecs[self.tp_rank].encode(hidden_states)
        else:
            features = None
...
class LlamaModel(nn.Module):
    ...
    def __init__(self,
        ...
        # init the codec for each rank for multi-gpu setup
        ...
        self.start_layer, self.end_layer, self.layers = make_layers(
            ...
            lambda prefix: layer_type(vllm_config=vllm_config, prefix=prefix, cached_codecs=self.cached_codecs),
